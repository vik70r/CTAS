            ...
            <div class="panel panel-success">
                <div class="panel-body" align="">
                    <div class="panel-default" align="center">
                        <h3 class="text-muted" align="center">Datos de Turno {{ $turno -> nombre }}</h3>
                    </div>
					<table id="example1" class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
		                ...
		                <tbody role="alert" aria-live="polite" aria-relevant="all">
		                    <tr class="odd">
		                        ...
		                        <td class="" align="center">{{ $turno -> id }}</td>
		                    </tr>
		                    <tr class="odd">
		                        <td class=" sorting_1" align="center">NOMBRE</td>
		                        <td class="" align="center">{{ $turno -> nombre }}</td>
		                    </tr>
		                </tbody>
            		</table>
					<p align="center">{{HTML::linkAction('TurnoController@index', 'Regresar')}}</p>
                </div>
            </div>
        </div>
    </div>
