			...
			<div class="box">
				...
				<div class="content forms">
                  <div class="row">
                      ...
                      <input name="anombre" type="text"  placeholder="Se Requiere un Nombre" required="required" autofocus="autofocus" value="" class="medium" />
                  </div>
                  <div class="row">
                      <label for="adireccion">Direccion:</label>
                      <input name="adireccion" type="text" placeholder="Se Requiere una Direccion" required="required"  value="" class="medium" />
                  </div>
                  <div class="row">
                      <label for="atelefono">Telefono:</label>
                      <input name="atelefono" type="text" placeholder="Se Requiere la Telefono" required="required" value="" class="medium" />
                  </div>
                 			
                  <div class="row buttons">
                     <button type="submit" name="BotonRegistro" id="BotonRegistro"><span>Registrar Agencia</span></button>
                  </div>
                </div>
			</div>
            </form>
...
if(isset($_POST['BotonRegistro'])){	
	$instancia->MantenimientoTagencia("",$anombre,$adireccion,$atelefono,"I");
	}
