...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="assets/princ/js/html5shiv.js"></script>
    <script src="assets/princ/js/respond.min.js"></script>
    <![endif]-->       
    ...
    <section id="about-us">
        <div class="container">
			<div class="center wow fadeInDown">
				...
				<p class="lead">Somos una empresa que nace del Cusco para mostrar todas las maravillas de nuestra tierra. <br>Un Equipo de Profesionales dispuestos a cumplir todas las necesidades de nuestros visitantes.</p>
			</div>
				...
				<div id="carousel-slider" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="assets/princ/images/slider_one.jpg" class="img-responsive" alt=""> 
					   </div>
					   <div class="item">
							<img src="assets/princ/images/slider_one.jpg" class="img-responsive" alt=""> 
					   </div> 
			...
			<div class="skill-wrap clearfix">
				...
				<div class="center wow fadeInDown">
					<h2>Ciudades</h2>
					<p class="lead">Tenemos a dispocicion personal experimentado en las ciudades mas hermozas<br> </p>
				</div>
			...
			<div class="team">
				<div class="center wow fadeInDown">
					<h2>Grupo de Gerencia</h2>
					<p class="lead">Grupo Profesional de Cusqueños dispuestos a Crecer con el Cusco</p>
				</div>
				...
				<div class="row clearfix">
					<div class="col-md-4 col-sm-6">	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="assets/princ/images/ff.jpg" alt=""></a>
								</div>
								<div class="media-body">
									<h4>Francisco Aguilar</h4>
									<h5>Founder </h5>
							...
							<p>Fundador de la empresa Center Travel ahora Center Travel Adventures. Economista cusqueño de nacimiento gran referente del turismo en el cusco.</p>
						</div>
					</div><!--/.col-lg-4 -->
					...
					<div class="col-md-4 col-sm-6 col-md-offset-2">	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="assets/princ/images/ss.jpg" alt=""></a>
								</div>
								<div class="media-body">
									<h4>Gissella Aguilar</h4>
									<h5>Founder and gerent</h5>
							...
							<p>Gerente de Center Travel Adventures S.A.C. Ingeniera Industrial con experiencia en administración. </p>
						</div>
					</div><!--/.col-lg-4 -->					
				</div> <!--/.row -->
