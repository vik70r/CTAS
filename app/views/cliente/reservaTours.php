...
<div class="wrapper">
	<div class="container">
    <div id="header">
		<img src="imagenes/guia.jpg" width="300" height="190" alt="Logo" />
	...
	<div class="menu">
		...
		<div class="holder"> 
			...
			<div class="box">
				<div class="title">
					<h2>INGRESE PASAPORTE : &nbsp;<input name="buscapasaporte" type="text" value="" class="small" /></h2>
					<img src="admin/gfx/title-hide.gif" class="toggle" alt="" />
				</div>
				<div class="content forms">
                         
						<div class="row">
							<label>NOMBRE Y APELLIDOS: dalmiro, cuellar hh</label>
						</div>
                        <div class="row">
							<label>Pasaporte:</label><label>Nacionalidad:</label>
							<input name="apellido" type="text" value="" class="medium" />
						</div>
                        <div class="row">
							<label>Nacionalidad:</label>
							<input name="nacionalidad" type="text" value="" class="medium" />
						</div>
						<div class="row">
							<label>Pasaporte:</label>
							<input name="pasaporte" type="text" value="" class="small" />
						</div>
						
                        <div class="row">
							<label>Edad:</label>
							<input name="edad" type="text" value="" class="small" />
						</div>			
