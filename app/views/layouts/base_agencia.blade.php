...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Panel de Agencia | Center Travel Adventures S.A</title>
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    {{ HTML::image('assets/img/turis.png','User Image',array('class'=>'img-circle')) }}
                                                </div>
                                                <h4>
                                                    Sales Department
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
									{{ HTML::image('assets/img/avatarma.png','User Image',array('class'=>'img-circle')) }}
                                    <p>
                                        Agency
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="cliente">
                                <i class="fa fa-folder"></i> <span>Reserva de boleto</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li>{{ HTML::link('ReservaBoleto.html','Reservar') }}</li>
                                <li>{{ HTML::link('clientes','Editar Reservas') }}</li>
                            </ul>
                        </li>

                        <li class="treeview">
                            <a href="cliente">
                                <i class="fa fa-folder"></i> <span>clienteA</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li>{{ HTML::link('cliente/add.html','Agregar') }}</li>
